...
class sms_class_masking_json {
    ...
    public function send() {
            $dt=json_encode($this->data);
            $curlHandle = curl_init($this->smsserverip."/sms/api_sms_masking_send_json.php");
            curl_setopt($curlHandle, CURLOPT_CUSTOMREQUEST, "POST");
            curl_setopt($curlHandle, CURLOPT_POSTFIELDS, $dt);
            curl_setopt($curlHandle, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($curlHandle, CURLOPT_HTTPHEADER, array(
    ...
    public function balance() {	
            $dt=json_encode($this->data);
            $curlHandle = curl_init($this->smsserverip."/sms/api_sms_masking_balance_json.php");
            curl_setopt($curlHandle, CURLOPT_CUSTOMREQUEST, "POST");
            curl_setopt($curlHandle, CURLOPT_POSTFIELDS, $dt);
            curl_setopt($curlHandle, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($curlHandle, CURLOPT_HTTPHEADER, array(
