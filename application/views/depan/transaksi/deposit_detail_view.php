...
$detail_deposit = $this->forex->flow_data($flow_id);
	...
	?>
          ...
          <div class="col-md-4 col-xs-6">
            <ul class="list-group text-dark panel-shadow">
              ...
              <li class="list-group-item "> <a sshref="<?=base_url('withdraw-form');?>#" class="block text-center"><img style="width: 89px;" 
...
<!---NEW------>
			  <div class="main col-md-12">
				<div class="panel">
				  ...
				  <?php
				  $this->load->view('depan/inc/pages/deposit_detail_pages');
				  ?>
				  </div>
				</div>
			  </div>
