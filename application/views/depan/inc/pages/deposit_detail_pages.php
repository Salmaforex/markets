    ...
    <tr>
      <td><p>Deposit Order Detail<br />
        ...
        <table width="641" border="0">
          <tr>
            <td width="572" height="33" bgcolor="#0099cc"> Here your order deposit detail:.</td>
          </tr>
        </table>
        <table border="0" align="center" id="m_7063596389365770691yui_3_16_0_1_1450323941636_3312">
          <tbody id="m_7063596389365770691yui_3_16_0_1_1450323941636_3311">
            ...
            <tr>
              ...
              <td bgcolor="#CCCCCC" id="m_7063596389365770691yui_3_16_0_1_1450323941636_10"><strong>: </strong>$ <?=number_format($detail['orderDeposit'],2);?></td>
            </tr>
            <tr>
...
?>  
    ...
    <tr>
      <td>
	  <a href='<?=site_url('admin/deposit/approve/'.$flow_id);?>'><button>Approve</button></a>
	  <a href='<?=site_url('admin/deposit/cancel/'.$flow_id);?>'><button>Cancel</button></a>
	  </td>
    </tr>
  </tbody>
</table>
