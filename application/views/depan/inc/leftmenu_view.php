...
?>
    		<div class="main-left col-md-4">
            	<div class="box green-box">
                	<h3 class="box-title"><strong>SalmaForex Balance</strong></h3>
                    <div class="row large">
...
//echo_r($detail);
if($menu==2){
	if(isset($detail)&&$detail['type']=='staff'){
		$this->load->view('depan/inc/menu_staff_view');
		$menuShow=1;
	}
	...
	if(isset($detail)&&$detail['type']=='admin_trans'){
		$this->load->view('depan/inc/menu_admin_trans_view');
		$menuShow=1;
	}
	if(isset($detail)&&$detail['typeMember']=='patners'){
		$this->load->view('depan/inc/menu_patners_view');
		$menuShow=1;
	}
