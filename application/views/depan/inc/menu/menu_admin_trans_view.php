...
<?php } ?>
  ...
  <li> <a href="#"><i class="fa fa-server" aria-hidden="true"></i> <span class="text">Admin Tools</span></a> <span class="toggle fa fa-chevron-down"></span>
    <ul>
      ...
      <li><a href="<?=!isset($userlogin)?site_url("member/logout"):site_url("admin/listApi/deposit");?>#"><span class="fa fa-triangle-right"></span>Deposit </a></li>

      <li><a href="<?=!isset($userlogin)?site_url("member/logout"):site_url("admin/listApi/widtdrawal");?>#"><span class="fa fa-triangle-right"></span>Widtdrawal </a></li>
    </ul>
  </li>
