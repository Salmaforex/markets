...
<?php } ?>
  ...
  <li> <a href="#"><i class="fa fa-server" aria-hidden="true"></i> <span class="text">Admin Tools</span></a> <span class="toggle fa fa-chevron-down"></span>
    <ul>
      <li><a href="<?=base_url('admin/listApi/api');?>#"><span class="fa fa-triangle-right"></span>API</a></li>
      ...
      <li><a href="<?=base_url('admin/tarif');?>#"><span class="fa fa-triangle-right"></span>
	  Currency
	  </a></li>
  ...
  <li> <a href="#"><i class="fa fa-shield" aria-hidden="true"></i> <span class="text">Admin User </span></a> <span class="toggle fa fa-chevron-down"></span>
    <ul>
      <li><a href="<?=base_url('admin/listApi/account');?>#"><span class="fa fa-triangle-right"></span>Account MT4 </a></li>
      <li><a href="<?=base_url('admin/new_account');?>#"><span class="fa fa-triangle-right"></span>Menambah Account Baru </a></li>
      <li><a href="<?=base_url('member/listApi/approval');?>#"><span class="fa fa-triangle-right"></span>Approval </a></li>
      <li><a href="<?=base_url('member/listApi/user');?>#"><span class="fa fa-triangle-right"></span>Detail User</a></li>
<?php {?>
      <li><a href="<?=base_url('member/listApi/agent');?>#"><span class="fa fa-triangle-right"></span>Agent </a></li>
      <li><a href="<?=base_url('admin/update_agent');?>#"><span class="fa fa-triangle-right"></span>member convert to agent  </a></li>
<?php } ?>
    </ul>
  </li>
	...
	<div class="panel-heading no-padding partition-blue"> <a class="panel-link-title" href="<?=base_url('admin/complaint');?>#"><span class="fa fa-user"></span> <span class="text">Komplain</span></a> </div>
	<div class="panel-heading no-padding partition-blue"> <a class="panel-link-title" href="<?=base_url('admin/billing');?>#"><span class="fa fa-user"></span> <span class="text">Billing</span></a> </div>
