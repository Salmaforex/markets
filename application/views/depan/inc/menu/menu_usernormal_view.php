...
<div class="glossymenu">
	<a class="menuitem" href="<?=base_url('member');?>"><span class="glyphicon glyphicon-home"></span> Home2</a>
	<?php
...
//			if(isset($userlogin['document']) &&isset($userlogin['document']['status']) && $userlogin['document']['status']==1){
	...
	<div class="submenu">
		<ul>
			...
			<li><a href="<?=base_url('member/editpassword');?>"> <img class="ui--icon" src="<?=base_url();?>media/img/open-account.png" alt="" data-at2x="size:14px" data-retina-auto="1" style="margin-right: 5px;" />Edit Password</a>(on prgress)</li>
		</ul>
	</div>
