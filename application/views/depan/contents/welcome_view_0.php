    ...
    <div style='margin-top:30px;'>
		...
		<div class='box-welcome'> 
			<div class='box-info'>
				...
				<a href='<?=site_url("member/edit");?>'><button>Click Here</button></a>
				</div>
			</div>
			<div class='box-info'>
				<div class='box-detail'>
				<label>Change Password</label>
				<a href='<?=site_url("member/editpassword");?>'><button>Click Here</button></a>
				</div>
			</div>
			<div class='clear'></div>
			<div class='box-info'>
				...
				<a href='<?=site_url("deposit-form");?>'><button>Click Here</button></a>
				</div>
			</div>
			...
			<div class='box-info'>
				...
				<a href='<?=site_url("widtdrawal-form");?>'><button>Click Here</button></a>
				</div>
			</div>
			<div class='clear'></div>
		</div>
