           ...
           <div class="col-md-6 col-md-pull-4">
               <div class="login-module">
                   <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li><a href="#salma-forex" data-toggle="tab">Salma Markets</a></li>
               </ul>
...
<?php   }  
?>
                            <form id="online-login"  method="POST" action="<?=site_url('login/process');?>">
                               <div class="row">
                                   <div class="col-md-6">
...
?>
                                    ...
                                    <div class="col-md-6">
                                       <div class="input-group">
                                           <!--img src="<?=site_url();?>media/images/captcha.jpg" alt="captcha" /-->
                                  <button id="submit_login" class="btn btn-success btn-block btn-big">Login</button>
                                        </div>
                                        <div class="input-group">
                                        </div>
                                        <div class="text-center"><a class="small bright" href="<?=site_url('guest/forgot');?>" title="Forgot your passport?"><span class="glyphicon glyphicon-arrow-right"></span> Reset Password</a></div>
                                    </div>
                                </div>
                            </form>
                        </div>
