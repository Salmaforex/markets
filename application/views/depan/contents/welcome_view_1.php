								...
								<td>
                                    <div class="box solid blue-box text-center">
                                        <div class="box-padder15">
                                            ...
                                            <a class="btn btn-default" href='<?=site_url('member/listApi/partner');?>'><strong>
                                ...
                                <td>
                                    <div class="box solid blue-box text-center">
                                        <div class="box-padder15">
                                            ...
                                            <div class="vspace-15"></div>
                                            <a class="btn btn-default" href='#' href1='<?=site_url('member/listApi/patner_revenue');?>'><strong>
                ...
                <div class="box yellow-box">
					...
					<?php
							if(isset($userlogin['document']) &&isset($userlogin['document']['status']) && $userlogin['document']['status']==1){
								?><a class="btn btn-default" href='<?=site_url('member/edit');?>'><strong>Verified</strong></a><?php 
							}
							else{?>
                                            <a class="btn btn-default" href='<?=site_url('member/uploads');?>'><strong>Click Here</strong></a>
					<?php
							}?>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="box solid blue-box text-center">
                                        <div class="box-padder15">
                                            ...
                                            <div class="vspace-15"></div>
                                            <a class="btn btn-default" href='<?=site_url('member/editpassword');?>'><strong>Click Here</strong></a>
                                        </div>
                                    </div>
                                    <div class="vspace-30"></div>
                                </td>
                                ...
                                <td>
                                    <div class="box solid blue-box text-center">
                                        <div class="box-padder15">
                                            ...
                                            <div class="vspace-15"></div>
                                            <a class="btn btn-default" href='<?=site_url('member/edit');?>'><strong>Click Here</strong></a>
                                        </div>
                                    </div>
                                    <div class="vspace-30"></div>
                                </td>
                                ...
                                <td>
                                    <div class="box solid blue-box text-center">
                                        <div class="box-padder15">
                                            ...
                                            <div class="vspace-15"></div>
                                            <a class="btn btn-default" href='<?=site_url('deposit-form');?>'><strong>Click Here</strong></a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="box solid blue-box text-center">
                                        <div class="box-padder15">
                                            ...
                                            <div class="vspace-15"></div>
                                            <a class="btn btn-default" href='<?=site_url('withdraw-form');?>'><strong>Click Here</strong></a>
                                        </div>
                                    </div>
                                </td>
                                <td>
