...
?>
		<div class="main col-md-12">
			...
			echo bsInput('Phone','phone', trim($userlogin['phone']) ,'Please Input Valid Phonenumber' );
			echo bsInput('Nama Bank','bank', trim($userlogin['bank']) ,'BCA, Mandiri, etc' );
			echo bsInput('No Rekening','norek', trim($userlogin['bank_norek']) ,'999 999 999 9' );
			...
			'<div id="input_rate9">0</div>' ,'Minimal $10',true );
          ...
          <form class="form-horizontal" method="POST" >
            ...
            <div class="row no-margin">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label"> Account SalmaForex <span class="symbol required"></span> </label>
                <div class="col-sm-7">
<?php
$name=isset($userlogin['name'])?$userlogin['name']:''; 
$name1='<input type="hidden" name="name" value="'.$name.'" />
...
?>
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">Phone <span class="symbol required"></span> </label>
                <div class="col-sm-7">
                  <input class="form-control" id="accnumber" name="phone" placeholder="Account number" type="text" value='<?=trim($userlogin['phone']);?>' />
                </div>
              </div>
              <!--div class="form-group">
                <label class="col-sm-3 control-label"> Deposit Methode <span class="symbol required"></span> </label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label"> Bank Name <span class="symbol required"></span> </label>
                <div class="col-sm-7">
                  <input class="form-control" id="accnumber" name="bank" placeholder="Account number" type="text" value='<?=trim($userlogin['bank']);?>' />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label"> Bank account number <span class="symbol required"></span> </label>
                <div class="col-sm-7">
                  <input class="form-control" id="accnumber" name="norek" placeholder="Account number" type="text" value='<?=trim($userlogin['bank_norek']);?>'>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label"> Bank account owner Name <span class="symbol required"></span> </label>
                <div class="col-sm-7">
...
*/ ?>
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label"> Rate <span class="symbol required"></span> </label>
                <div class="col-sm-7">
                  <!--input class="form-control" id="rate" name="rate" placeholder="Rate" type="text" readonly value=''/--> <div id="input_rate">0</div>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label"> Deposit amount <span class="symbol required"></span> </label>
                <div class="col-sm-7">
                  <input type="text" name="orderDeposit" value="10" id="input_orderDeposit" class="form-control" placeholder="Minimal $10"  />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label"> Total <span class="symbol required"></span> </label>
                <div class="col-sm-7">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <button type="submit" class="btn btn-green"> Deposit <i class="fa fa-arrow-circle-right"></i> </button>
                </div>
              </div>
            </div>
              </div>
