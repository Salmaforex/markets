...
<table width="650" border="0" align="center" cellpadding="2" cellspacing="2">
  <tbody>
    ...
    <tr>
      <td height="408"><p>Withdrawal  Order Success<br />
        <br />
        Hello <?=$name;?>,<br />
      </p>
        <table width="641" border="0">
          <tr>
            <td width="572" height="33" bgcolor="#0099cc">Your Withdrawal Has been Success, Here your order withdrawal detail:.</td>
          </tr>
        </table>
        ...
        <p>In case you have any questions, please <a rel="nofollow" target="_blank" href="https://www.salmamarkets.com/contact-us/" id="yui_3_16_0_1_1443010679159_2161">contact us</a>, we will be happy to answer them.</p>
...
$subject = '[SalmaMarkets] Confirmation to Widthdrawal ';
