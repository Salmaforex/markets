...
<table width="650" border="0" align="center" cellpadding="2" cellspacing="2">
  <tbody>
    ...
    <tr>
      <td height="408"><p>Deposit Order Not Approved<br />
        <br />
        Hello <?=$name;?>,<br />
      </p>
        <table width="641" border="0">
          <tr>
            <td width="572" height="33" bgcolor="#0099cc">Your Deposit Not Approved, Here your order deposit detail:.</td>
          </tr>
        </table>
        <table border="0" align="center" id="yui_3_16_0_1_1450323941636_3312">
          <tbody id="yui_3_16_0_1_1450323941636_3311">
            ...
            <tr>
              ...
              <td bgcolor="#CCCCCC" id="yui_3_16_0_1_1450323941636_12"><strong>: </strong><?=number_format($raw['order1'],0);?></td>
            </tr>
            <tr>
...
$subject = '[SalmaMarkets] Confirmation to Deposit ';
...
if(defined('LOCAL')){	
	...
	$subject = "[SalmaMarkets] Update Account";
	$data=array( 'url'=>json_encode($to),
		'parameter'=>json_encode($rawEmail),
		'error'=>2
	);
